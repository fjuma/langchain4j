...
import static dev.langchain4j.data.message.CustomMessage.customMessage;
...
class OllamaCustomMessageChatModelIT extends AbstractOllamaLanguageModelInfrastructure {
    ...
    void should_generate_response_with_custom_message() {
        ...
        CustomMessage customMessage = customMessage("context", attributes);

        // when
        Response<AiMessage> response = ollamaChatModel.generate(systemMessage, userMessage, customMessage);
        ...
        customMessage = customMessage("context", attributes);
        ...
        // when
        response = ollamaChatModel.generate(systemMessage, customMessage, aiMessage);
