...
class DocumentByParagraphSplitterTest {
        ...
        assertThat(segments)
                .containsExactly(
                        ...
                        textSegment(
                                ...
                                metadata("index", "2").put("document", "0")),
        ...
        assertThat(segments)
                .containsExactly(
                        ...
                        textSegment(
                                ...
                                metadata("index", "4").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s %s %s", s19, s20, s21, s22, s23, s24),
                                metadata("index", "5").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s %s %s", s22, s23, s24, s25, s26, s27),
                                metadata("index", "6").put("document", "0")),
                        textSegment(
    ...
    void should_split_sample_text_without_paragraphs_with_small_overlap() {
        ...
        assertThat(segments)
                .containsExactly(
                        TextSegment.from(
                                sentences(0, 5), Metadata.from("index", "0").put("document", "0")),
                        TextSegment.from(
                                sentences(5, 12), Metadata.from("index", "1").put("document", "0")),
                        TextSegment.from(
                                sentences(10, 16), Metadata.from("index", "2").put("document", "0")),
                        TextSegment.from(
                                sentences(15, 24), Metadata.from("index", "3").put("document", "0")),
                        TextSegment.from(
                                sentences(21, 28), Metadata.from("index", "4").put("document", "0")));
        ...
        assertThat(segments)
                .containsExactly(
                        TextSegment.from(
                                sentences(0, 5), Metadata.from("index", "0").put("document", "0")),
                        TextSegment.from(
                                sentences(1, 6), Metadata.from("index", "1").put("document", "0")),
                        TextSegment.from(
                                sentences(3, 8), Metadata.from("index", "2").put("document", "0")),
                        // TODO fix chopped "Mrs."
                        TextSegment.from(
                                sentences(4, 10) + " Mrs.",
                                Metadata.from("index", "3").put("document", "0")),
                        TextSegment.from(
                                sentences(5, 12), Metadata.from("index", "4").put("document", "0")),
                        TextSegment.from(
                                sentences(7, 15), Metadata.from("index", "5").put("document", "0")),
                        TextSegment.from(
                                sentences(9, 16), Metadata.from("index", "6").put("document", "0")),
                        ...
                        TextSegment.from(
                                ...
                                Metadata.from("index", "7").put("document", "0")),
                        // TODO this segment should not be present, there is s14-s19 below
                        TextSegment.from(
                                sentences(13, 17), Metadata.from("index", "8").put("document", "0")),
                        TextSegment.from(
                                sentences(13, 18), Metadata.from("index", "9").put("document", "0")),
                        TextSegment.from(
                                sentences(14, 23), Metadata.from("index", "10").put("document", "0")),
                        TextSegment.from(
                                sentences(16, 24), Metadata.from("index", "11").put("document", "0")),
                        TextSegment.from(
                                sentences(17, 26), Metadata.from("index", "12").put("document", "0")),
                        TextSegment.from(
                                sentences(18, 28), Metadata.from("index", "13").put("document", "0")));
